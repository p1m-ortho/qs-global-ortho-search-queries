...
292 записи (`citations.nbib` и `citations (1).nbib` прилагаются).

Выгружаем в Rayyan.

Критерий исключения один: не соответствует PICO-формуле,— поэтому в Rayyan не будем  даже указывать.