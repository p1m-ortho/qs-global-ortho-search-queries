...
Поэтому я не исключаю ни по какой этиологии псоас-абсцесса. Не исключаю ни по какому генезу, потому что это не указано в PICO. Исключаю по `wrong_population` все явно не связанное со спондилодисцитом, потому что это указано в PICO. Не исключаю вторичные остеомиелиты, потому что это указано в PICO (и да, спондилодисцит, остеомиелит позвоночника и спондилит я расцениваю как синонимы). Не исключаю по `wrong drug` вообще, потому что группы основного вмешательства и сравнения сформулированы таким образом, что включают все возможные вмешательства.
