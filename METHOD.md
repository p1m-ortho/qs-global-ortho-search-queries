...
Попробую проделать это для оставшихся 262/348 записей, а также для 86/348 уже исключенных записей. «Попробую» потому, что, если это будет занимать слишком много времени, возможно, придется от этого отказаться.
