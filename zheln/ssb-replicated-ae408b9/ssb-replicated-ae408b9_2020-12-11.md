...
* When run on Dec 13, 2020, this query returned [375 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-11_375.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/11[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/11[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/11:2020/12/11[crdt] OR 2020/12/11:2020/12/11[dcom] OR 2020/12/11:2020/12/11[mhda])
```
