...
* When run on Dec 8, 2020, this query returned [257 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-05_257.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/05[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/05[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/05:2020/12/05[crdt] OR 2020/12/05:2020/12/05[dcom] OR 2020/12/05:2020/12/05[mhda])
```
