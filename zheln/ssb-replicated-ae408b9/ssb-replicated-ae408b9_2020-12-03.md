...
* When run on Dec 5, 2020, and Dec 8, 2020, this query returned a generic error. However, `(2020/12/03:2020/12/03[crdt] OR 2020/12/03:2020/12/03[dcom] OR 2020/12/03:2020/12/03[mhda])` was successful and produced 11,274 results (both times).
* When run once again late on Dec 8, 2020, this query returned [341 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-03_341.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/03[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/03[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/03:2020/12/03[crdt] OR 2020/12/03:2020/12/03[dcom] OR 2020/12/03:2020/12/03[mhda])
```
