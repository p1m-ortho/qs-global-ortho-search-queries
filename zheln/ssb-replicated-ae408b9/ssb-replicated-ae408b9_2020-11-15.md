...
* When run on Nov 17, 2020, this query returned [141 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-15_141.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/15[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/15[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/15:2020/11/15[crdt] OR 2020/11/15:2020/11/15[dcom] OR 2020/11/15:2020/11/15[mhda])
```
