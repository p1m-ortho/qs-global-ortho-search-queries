...
* When run on Nov 17, 2020, this query returned [576 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-16_576.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/16[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/16[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/16:2020/11/16[crdt] OR 2020/11/16:2020/11/16[dcom] OR 2020/11/16:2020/11/16[mhda])
```
