...
* When run on August 24, 2022, this query returned [1,780 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-08-17_thru_2022-08-22_1780.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/08/22[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/08/22[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/08/17:2022/08/22[crdt] OR 2022/08/17:2022/08/22[dcom] OR 2022/08/17:2022/08/22[mhda])
```
