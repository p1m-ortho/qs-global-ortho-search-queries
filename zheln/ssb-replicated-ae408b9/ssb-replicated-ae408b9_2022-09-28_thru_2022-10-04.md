...
* When run on October 5, 2022, this query returned [2,714 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-09-28_thru_2022-10-04_2714.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/10/04[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/10/04[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/09/28:2022/10/04[crdt] OR 2022/09/28:2022/10/04[dcom] OR 2022/09/28:2022/10/04[mhda])
```
