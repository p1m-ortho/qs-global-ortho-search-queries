...
* When run on May 20, 2022, this query returned [715 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-05-19_715.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/05/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/05/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/05/19:2022/05/19[crdt] OR 2022/05/19:2022/05/19[dcom] OR 2022/05/19:2022/05/19[mhda])
```
