...
* When run on Dec 26, 2020, this query returned [583 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-23_583.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/23[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/23[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/23:2020/12/23[crdt] OR 2020/12/23:2020/12/23[dcom] OR 2020/12/23:2020/12/23[mhda])
```
