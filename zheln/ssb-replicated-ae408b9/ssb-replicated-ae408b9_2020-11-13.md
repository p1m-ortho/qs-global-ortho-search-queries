...
* When run on Nov 15, 2020, this query returned [558 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-13_558.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/13[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/13[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/13:2020/11/13[crdt] OR 2020/11/13:2020/11/13[dcom] OR 2020/11/13:2020/11/13[mhda])
```
