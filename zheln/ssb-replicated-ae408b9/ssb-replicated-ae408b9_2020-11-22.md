...
* When run on Nov 24, 2020, this query returned [232 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-22_232.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/22[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/22[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/22:2020/11/22[crdt] OR 2020/11/22:2020/11/22[dcom] OR 2020/11/22:2020/11/22[mhda])
```
