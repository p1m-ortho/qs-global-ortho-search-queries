...
* When run on August 3, 2022, this query returned [2,499 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-07-26_thru_2022-08-01_2499.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/08/01[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/08/01[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/07/26:2022/08/01[crdt] OR 2022/07/26:2022/08/01[dcom] OR 2022/07/26:2022/08/01[mhda])
```
