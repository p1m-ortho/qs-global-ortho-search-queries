...
* When run on Dec 21, 2020, this query returned [300 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-19_300.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/19:2020/12/19[crdt] OR 2020/12/19:2020/12/19[dcom] OR 2020/12/19:2020/12/19[mhda])
```
etter"[pt] OR "newspaper article"[pt]
            )
            AND
            1865/01/01:2020/12/19[dcom]
        )
