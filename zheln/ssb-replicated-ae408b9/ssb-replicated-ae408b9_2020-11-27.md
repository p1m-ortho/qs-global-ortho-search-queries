...
* When run on Nov 30, 2020, this query returned [389 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-27_389.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/27[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/27[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/27:2020/11/27[crdt] OR 2020/11/27:2020/11/27[dcom] OR 2020/11/27:2020/11/27[mhda])
```
