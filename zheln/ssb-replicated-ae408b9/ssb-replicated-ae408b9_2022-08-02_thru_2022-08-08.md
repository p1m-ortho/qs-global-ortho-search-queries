...
* When run on August 9, 2022, this query returned [2,137 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-08-02_thru_2022-08-08_2137.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/08/08[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/08/08[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/08/02:2022/08/08[crdt] OR 2022/08/02:2022/08/08[dcom] OR 2022/08/02:2022/08/08[mhda])
```
