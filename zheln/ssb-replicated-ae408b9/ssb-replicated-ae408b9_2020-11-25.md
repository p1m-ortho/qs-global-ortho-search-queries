...
* When run on Nov 26, 2020, this query returned [648 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-25_648.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/25:2020/11/25[crdt] OR 2020/11/25:2020/11/25[dcom] OR 2020/11/25:2020/11/25[mhda])
```
