...
* When run on May 4, 2022, this query returned [1,159 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-05-03_1159.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/05/03[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/05/03[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/05/03:2022/05/03[crdt] OR 2022/05/03:2022/05/03[dcom] OR 2022/05/03:2022/05/03[mhda])
```
