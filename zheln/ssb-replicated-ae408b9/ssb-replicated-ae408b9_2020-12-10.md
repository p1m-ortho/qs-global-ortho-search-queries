...
* When run on Dec 12, 2020, this query returned [383 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-10_383.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/10:2020/12/10[crdt] OR 2020/12/10:2020/12/10[dcom] OR 2020/12/10:2020/12/10[mhda])
```
