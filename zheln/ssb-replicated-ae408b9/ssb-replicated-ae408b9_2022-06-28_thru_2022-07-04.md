...
* When run on July 5, 2022, this query returned [1,774 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-06-28_thru_2022-07-04_1774.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/07/04[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/07/04[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/06/28:2022/07/04[crdt] OR 2022/06/28:2022/07/04[dcom] OR 2022/06/28:2022/07/04[mhda])
```
