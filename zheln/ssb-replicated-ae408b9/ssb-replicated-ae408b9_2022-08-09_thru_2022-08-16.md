...
* When run on August 18, 2022, this query returned [2,773 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-08-09_thru_2022-08-16_2773.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/08/16[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/08/16[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/08/09:2022/08/16[crdt] OR 2022/08/09:2022/08/16[dcom] OR 2022/08/09:2022/08/16[mhda])
```
