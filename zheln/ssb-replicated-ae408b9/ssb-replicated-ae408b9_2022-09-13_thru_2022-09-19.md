...
* When run on September 20, 2022, this query returned [2,421 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-09-13_thru_2022-09-19_2421.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/09/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/09/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/09/13:2022/09/19[crdt] OR 2022/09/13:2022/09/19[dcom] OR 2022/09/13:2022/09/19[mhda])
```
