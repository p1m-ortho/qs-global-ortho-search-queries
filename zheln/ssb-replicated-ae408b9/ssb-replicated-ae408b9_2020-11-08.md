...
* When run on Nov 10, 2020, this query returned [180 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-08_180.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/08[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/08[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/08:2020/11/08[crdt] OR 2020/11/08:2020/11/08[dcom] OR 2020/11/08:2020/11/08[mhda])
```
