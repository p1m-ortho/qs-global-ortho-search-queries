...
* When run on April 21, 2022, this query returned [920 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-04-20_920.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/04/20[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/04/20[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/04/20:2022/04/20[crdt] OR 2022/04/20:2022/04/20[dcom] OR 2022/04/20:2022/04/20[mhda])
```
