...
* When run on Nov 9, 2020, this query returned [290 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-07_290.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/07[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/07[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/07:2020/11/07[crdt] OR 2020/11/07:2020/11/07[dcom] OR 2020/11/07:2020/11/07[mhda])
```
