...
* When run on Nov 30, 2020, this query returned [211 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-28_211.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/28[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/28[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/28:2020/11/28[crdt] OR 2020/11/28:2020/11/28[dcom] OR 2020/11/28:2020/11/28[mhda])
```
