...
* When run on Nov 20, 2020, this query returned [490 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-19_490.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/19:2020/11/19[crdt] OR 2020/11/19:2020/11/19[dcom] OR 2020/11/19:2020/11/19[mhda])
```
