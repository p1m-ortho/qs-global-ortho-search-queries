...
* When run on Nov 13, 2020, this query returned [759 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-12_759.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/12[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/12[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/12:2020/11/12[crdt] OR 2020/11/12:2020/11/12[dcom] OR 2020/11/12:2020/11/12[mhda])
```
