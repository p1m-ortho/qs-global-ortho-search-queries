...
* When run on June 8, 2022, this query returned [622 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-06-06_622.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/06/06[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/06/06[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/06/06:2022/06/06[crdt] OR 2022/06/06:2022/06/06[dcom] OR 2022/06/06:2022/06/06[mhda])
```
