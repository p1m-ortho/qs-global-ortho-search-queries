...
* When run on September 28, 2022, this query returned [2,793 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-09-20_thru_2022-09-27_2793.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/09/27[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/09/27[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/09/20:2022/09/27[crdt] OR 2022/09/20:2022/09/27[dcom] OR 2022/09/20:2022/09/27[mhda])
```
