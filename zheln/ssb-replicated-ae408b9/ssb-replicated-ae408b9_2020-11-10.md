...
* When run on Nov 11, 2020, this query returned [490 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-10_490.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/10:2020/11/10[crdt] OR 2020/11/10:2020/11/10[dcom] OR 2020/11/10:2020/11/10[mhda])
```
