...
* When run on May 11, 2022, this query returned [961 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-05-10_961.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/05/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/05/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/05/10:2022/05/10[crdt] OR 2022/05/10:2022/05/10[dcom] OR 2022/05/10:2022/05/10[mhda])
```
