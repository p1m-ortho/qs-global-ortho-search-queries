...
* When run on April 13, 2022, this query returned [1,216 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-04-12_1216.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/04/12[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/04/12[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/04/12:2022/04/12[crdt] OR 2022/04/12:2022/04/12[dcom] OR 2022/04/12:2022/04/12[mhda])
```
