...
* When run on Dec 8, 2020, this query returned [132 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-06_132.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/06[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/06[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/06:2020/12/06[crdt] OR 2020/12/06:2020/12/06[dcom] OR 2020/12/06:2020/12/06[mhda])
```
