...
* When run on Nov 28, 2020, this query returned [561 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-26_561.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/26[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/26[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/26:2020/11/26[crdt] OR 2020/11/26:2020/11/26[dcom] OR 2020/11/26:2020/11/26[mhda])
```
