...
* When run on October 18, 2022, this query returned [2,532 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-10-12_thru_2022-10-17_2532.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/10/17[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/10/17[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/10/12:2022/10/17[crdt] OR 2022/10/12:2022/10/17[dcom] OR 2022/10/12:2022/10/17[mhda])
```
