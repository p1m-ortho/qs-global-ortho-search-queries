...
* When run on April 6, 2022, this query returned [1,387 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-04-05_1387.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/04/05[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/04/05[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/04/05:2022/04/05[crdt] OR 2022/04/05:2022/04/05[dcom] OR 2022/04/05:2022/04/05[mhda])
```
