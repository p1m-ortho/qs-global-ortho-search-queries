...
* When run on July 20, 2022, this query returned [1,771 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-07-14_thru_2022-07-18_1771.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/07/18[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/07/18[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/07/14:2022/07/18[crdt] OR 2022/07/14:2022/07/18[dcom] OR 2022/07/14:2022/07/18[mhda])
```
