...
* When run on September 7, 2022, this query returned [2,425 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-08-30_thru_2022-09-06_2425.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/09/06[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/09/06[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/08/30:2022/09/06[crdt] OR 2022/08/30:2022/09/06[dcom] OR 2022/08/30:2022/09/06[mhda])
```
