...
* When run on July 27, 2022, this query returned [2,237 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-07-19_thru_2022-07-25_2237.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/07/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/07/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/07/19:2022/07/25[crdt] OR 2022/07/19:2022/07/25[dcom] OR 2022/07/19:2022/07/25[mhda])
```
