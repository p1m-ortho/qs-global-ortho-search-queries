...
* When run on Dec 14, 2020, and Dec 16, 2020, this query returned a 502 error. I did rerun the query using VPN but got the same result. Also, `(2020/12/13:2020/12/13[crdt] OR 2020/12/13:2020/12/13[dcom] OR 2020/12/13:2020/12/13[mhda])` was unsuccessful and produced zero results (both times).
