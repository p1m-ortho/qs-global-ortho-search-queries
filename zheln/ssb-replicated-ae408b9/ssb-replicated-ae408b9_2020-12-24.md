...
* When run on Dec 26, 2020, this query returned [150 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-24_150.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/24[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/24[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/24:2020/12/24[crdt] OR 2020/12/24:2020/12/24[dcom] OR 2020/12/24:2020/12/24[mhda])
```
