...
* When run on Dec 16, 2020, this query returned [2,146 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-15_2146.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/15[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/15[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/15:2020/12/15[crdt] OR 2020/12/15:2020/12/15[dcom] OR 2020/12/15:2020/12/15[mhda])
```
