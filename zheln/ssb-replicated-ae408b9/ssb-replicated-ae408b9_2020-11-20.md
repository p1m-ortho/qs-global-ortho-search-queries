...
* When run on Nov 22, 2020, this query returned [655 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-20_655.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/20[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/20[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/20:2020/11/20[crdt] OR 2020/11/20:2020/11/20[dcom] OR 2020/11/20:2020/11/20[mhda])
```
