...
* When run on Dec 23, 2020, this query returned [696 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-21_696.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/21[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/21[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/21:2020/12/21[crdt] OR 2020/12/21:2020/12/21[dcom] OR 2020/12/21:2020/12/21[mhda])
```
