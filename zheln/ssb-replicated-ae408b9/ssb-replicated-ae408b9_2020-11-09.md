...
* When run on Nov 11, 2020, this query returned [525 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-09_525.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/09[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/09[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/09:2020/11/09[crdt] OR 2020/11/09:2020/11/09[dcom] OR 2020/11/09:2020/11/09[mhda])
```
