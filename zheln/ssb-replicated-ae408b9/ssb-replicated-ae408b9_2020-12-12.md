...
* When run on Dec 14, 2020, this query returned [206 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-12_206.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/12[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/12[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/12:2020/12/12[crdt] OR 2020/12/12:2020/12/12[dcom] OR 2020/12/12:2020/12/12[mhda])
```
