...
* When run on Dec 3, 2020, this query returned [485 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-02_485.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/02:2020/12/02[crdt] OR 2020/12/02:2020/12/02[dcom] OR 2020/12/02:2020/12/02[mhda])
```
ok"[all]
                        AND
                        1865/01/01:2020/12/01[dcom]
                    )
                )
            )
        )
...
) AND (2020/12/01:2020/12/01[crdt] OR 2020/12/01:2020/12/01[dcom] OR 2020/12/01:2020/12/01[mhda])
```
