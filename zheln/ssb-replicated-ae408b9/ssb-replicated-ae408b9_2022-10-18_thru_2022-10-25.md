...
* When run on October 26, 2022, this query returned [2,941 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-10-18_thru_2022-10-25_2941.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/10/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/10/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/10/18:2022/10/25[crdt] OR 2022/10/18:2022/10/25[dcom] OR 2022/10/18:2022/10/25[mhda])
```
