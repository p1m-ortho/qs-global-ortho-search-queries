...
* When run on September 14, 2022, this query returned [2,291 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-09-07_thru_2022-09-12_2291.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/09/12[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/09/12[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/09/07:2022/09/12[crdt] OR 2022/09/07:2022/09/12[dcom] OR 2022/09/07:2022/09/12[mhda])
```
