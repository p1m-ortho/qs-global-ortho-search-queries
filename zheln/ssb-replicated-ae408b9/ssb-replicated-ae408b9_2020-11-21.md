...
* When run on Nov 24, 2020, this query returned [344 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-21_344.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/21[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/21[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/21:2020/11/21[crdt] OR 2020/11/21:2020/11/21[dcom] OR 2020/11/21:2020/11/21[mhda])
```
