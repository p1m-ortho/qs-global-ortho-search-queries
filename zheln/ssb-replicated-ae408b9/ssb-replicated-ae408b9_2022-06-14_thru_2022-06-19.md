...
* When run on June 21, 2022, this query returned [2,079 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-06-14_thru_2022-06-19_2079.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/06/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/06/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/06/14:2022/06/19[crdt] OR 2022/06/14:2022/06/19[dcom] OR 2022/06/14:2022/06/19[mhda])
```
