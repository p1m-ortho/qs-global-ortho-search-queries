...
* When run on Dec 2, 2020, this query returned [528 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-30_528.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/30[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/30[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/30:2020/11/30[crdt] OR 2020/11/30:2020/11/30[dcom] OR 2020/11/30:2020/11/30[mhda])
```
