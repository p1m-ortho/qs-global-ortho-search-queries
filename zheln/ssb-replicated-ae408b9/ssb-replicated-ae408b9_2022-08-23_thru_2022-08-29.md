...
* When run on August 31, 2022, this query returned [2,557 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-08-23_thru_2022-08-29_2557.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/08/29[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/08/29[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/08/23:2022/08/29[crdt] OR 2022/08/23:2022/08/29[dcom] OR 2022/08/23:2022/08/29[mhda])
```
