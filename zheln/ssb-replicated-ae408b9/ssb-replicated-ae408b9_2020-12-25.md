...
* When run on Dec 30, 2020, this query returned [23 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-25_23.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/25:2020/12/25[crdt] OR 2020/12/25:2020/12/25[dcom] OR 2020/12/25:2020/12/25[mhda])
```
