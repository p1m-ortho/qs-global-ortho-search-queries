...
* When run on Nov 25, 2020, this query returned [785 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-24_785.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/24[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/24[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/24:2020/11/24[crdt] OR 2020/11/24:2020/11/24[dcom] OR 2020/11/24:2020/11/24[mhda])
```
