...
* When run on Nov 20, 2020, this query returned [932 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-18_932.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/18[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/18[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/18:2020/11/18[crdt] OR 2020/11/18:2020/11/18[dcom] OR 2020/11/18:2020/11/18[mhda])
```
