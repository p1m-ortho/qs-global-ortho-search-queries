...
* When run on October 12, 2022, this query returned [2,169 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-10-05_thru_2022-10-11_2169.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/10/11[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/10/11[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/10/05:2022/10/11[crdt] OR 2022/10/05:2022/10/11[dcom] OR 2022/10/05:2022/10/11[mhda])
```
