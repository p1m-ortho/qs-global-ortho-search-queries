...
* When run on Dec 30, 2020, this query returned a 502 error. Also, `(2020/12/27:2020/12/27[crdt] OR 2020/12/27:2020/12/27[dcom] OR 2020/12/27:2020/12/27[mhda])` produced one result only ([PMID 33355744](https://pubmed.gov/33355744)).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/27[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/27[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/27:2020/12/27[crdt] OR 2020/12/27:2020/12/27[dcom] OR 2020/12/27:2020/12/27[mhda])
```
