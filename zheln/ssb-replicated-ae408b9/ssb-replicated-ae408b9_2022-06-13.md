...
* When run on June 14, 2022, this query returned [535 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-06-13_535.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/06/13[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/06/13[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/06/13:2022/06/13[crdt] OR 2022/06/13:2022/06/13[dcom] OR 2022/06/13:2022/06/13[mhda])
```
