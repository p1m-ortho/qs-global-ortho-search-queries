...
* When run on Dec 30, 2020, this query returned a 502 error. Also, `(2020/12/26:2020/12/26[crdt] OR 2020/12/26:2020/12/26[dcom] OR 2020/12/26:2020/12/26[mhda])` produced one result only ([PMID 33355743](https://pubmed.gov/33355743)).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/26[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/26[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/26:2020/12/26[crdt] OR 2020/12/26:2020/12/26[dcom] OR 2020/12/26:2020/12/26[mhda])
```
