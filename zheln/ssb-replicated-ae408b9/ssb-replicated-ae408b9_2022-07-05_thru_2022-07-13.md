...
* When run on July 15, 2022, this query returned [2,908 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-07-05_thru_2022-07-13_2908.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/07/13[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/07/13[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/07/05:2022/07/13[crdt] OR 2022/07/05:2022/07/13[dcom] OR 2022/07/05:2022/07/13[mhda])
```
