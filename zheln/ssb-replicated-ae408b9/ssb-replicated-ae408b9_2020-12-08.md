...
* When run on Dec 9, 2020, this query returned [380 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-08_380.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/08[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/08[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/08:2020/12/08[crdt] OR 2020/12/08:2020/12/08[dcom] OR 2020/12/08:2020/12/08[mhda])
```
