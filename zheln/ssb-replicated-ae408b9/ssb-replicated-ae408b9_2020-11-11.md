...
* When run on Nov 13, 2020, this query returned [998 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-11-11_998.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/11/11[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/11/11[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/11/11:2020/11/11[crdt] OR 2020/11/11:2020/11/11[dcom] OR 2020/11/11:2020/11/11[mhda])
```
