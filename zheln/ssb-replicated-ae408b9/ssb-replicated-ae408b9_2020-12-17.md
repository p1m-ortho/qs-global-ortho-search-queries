...
* When run on Dec 18, 2020, this query returned a 502 error. At the same time, `(2020/12/17:2020/12/17[crdt] OR 2020/12/17:2020/12/17[dcom] OR 2020/12/17:2020/12/17[mhda])` ran successfully and produced 19,642 results.
* When rerun late on Dec 18, 2020, this query returned [704 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-17_704.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/17[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/17[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/17:2020/12/17[crdt] OR 2020/12/17:2020/12/17[dcom] OR 2020/12/17:2020/12/17[mhda])
```
