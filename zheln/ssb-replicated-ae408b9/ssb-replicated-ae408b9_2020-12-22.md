...
* When run on Dec 25, 2020, this query returned [961 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2020-12-22_961.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2020/12/22[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2020/12/22[dcom]
                )
                NOT
                (
                    (
...
) AND (2020/12/22:2020/12/22[crdt] OR 2020/12/22:2020/12/22[dcom] OR 2020/12/22:2020/12/22[mhda])
```
