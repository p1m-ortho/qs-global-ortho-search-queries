...
When run on June 11, 2023, this query returned [2,241 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-06-04_thru_2023-06-10_2241.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/06/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/06/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/06/04:2023/06/10[crdt] OR 2023/06/04:2023/06/10[dcom] OR 2023/06/04:2023/06/10[mhda] OR 2023/06/04:2023/06/10[edat])
```
