...
When run on September 25, 2023, this query returned [1,486 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-09-19_thru_2023-09-24_1486.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/09/24[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/09/24[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/09/19:2023/09/24[crdt] OR 2023/09/19:2023/09/24[dcom] OR 2023/09/19:2023/09/24[mhda] OR 2023/09/19:2023/09/24[edat])
```
