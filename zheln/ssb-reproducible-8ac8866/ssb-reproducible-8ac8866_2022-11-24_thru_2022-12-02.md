...
When run on December 3, 2022, this query returned [3,098 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-11-24_thru_2022-12-02_3098.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/12/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/12/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/11/24:2022/12/02[crdt] OR 2022/11/24:2022/12/02[dcom] OR 2022/11/24:2022/12/02[mhda]  OR 2022/11/24:2022/12/02[edat])
```
