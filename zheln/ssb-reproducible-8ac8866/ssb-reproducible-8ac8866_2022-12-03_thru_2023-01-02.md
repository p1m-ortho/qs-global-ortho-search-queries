...
When run on January 3, 2023, this query returned [8,189 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-12-03_thru_2023-01-02_8189.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/01/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/01/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/12/03:2023/01/02[crdt] OR 2022/12/03:2023/01/02[dcom] OR 2022/12/03:2023/01/02[mhda]  OR 2022/12/03:2023/01/02[edat])
```
