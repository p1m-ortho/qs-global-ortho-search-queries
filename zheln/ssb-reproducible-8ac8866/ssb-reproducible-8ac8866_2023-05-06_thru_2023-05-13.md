...
When run on May 14, 2023, this query returned [2,200 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-05-06_thru_2023-05-13_2200.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/05/13[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/05/13[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/05/06:2023/05/13[crdt] OR 2023/05/06:2023/05/13[dcom] OR 2023/05/06:2023/05/13[mhda]  OR 2023/05/06:2023/05/13[edat])
```
