...
When run on September 11, 2023, this query returned [1,662 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-09-05_thru_2023-09-10_1662.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/09/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/09/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/09/05:2023/09/10[crdt] OR 2023/09/05:2023/09/10[dcom] OR 2023/09/05:2023/09/10[mhda] OR 2023/09/05:2023/09/10[edat])
```
