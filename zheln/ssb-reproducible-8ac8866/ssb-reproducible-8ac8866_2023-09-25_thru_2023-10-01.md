...
When run on October 2, 2023, this query returned [2,195 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-09-25_thru_2023-10-01_2195.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/10/01[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/10/01[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/09/25:2023/10/01[crdt] OR 2023/09/25:2023/10/01[dcom] OR 2023/09/25:2023/10/01[mhda] OR 2023/09/25:2023/10/01[edat])
```
