...
When run on January 2, 2024, this query returned [1,946 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-12-23_thru_2024-01-01_1946.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/01/01[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/01/01[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/12/23:2024/01/01[crdt] OR 2023/12/23:2024/01/01[dcom] OR 2023/12/23:2024/01/01[mhda] OR 2023/12/23:2024/01/01[edat])
```
