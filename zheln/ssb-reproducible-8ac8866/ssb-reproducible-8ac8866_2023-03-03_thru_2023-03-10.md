...
When run on March 11, 2023, this query returned [3,490 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-03-03_thru_2023-03-10_3490.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/03/10[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/03/10[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/03/03:2023/03/10[crdt] OR 2023/03/03:2023/03/10[dcom] OR 2023/03/03:2023/03/10[mhda]  OR 2023/03/03:2023/03/10[edat])
```
