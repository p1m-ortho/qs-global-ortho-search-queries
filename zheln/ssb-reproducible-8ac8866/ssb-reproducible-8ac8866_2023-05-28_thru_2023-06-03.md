...
When run on June 4, 2023, this query returned [1,943 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-05-28_thru_2023-06-03_1943.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/06/03[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/06/03[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/05/28:2023/06/03[crdt] OR 2023/05/28:2023/06/03[dcom] OR 2023/05/28:2023/06/03[mhda] OR 2023/05/28:2023/06/03[edat])
```
