...
When run on April 15, 2023, this query returned [2,090 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-04-08_thru_2023-04-14_2090.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/04/14[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/04/14[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/04/08:2023/04/14[crdt] OR 2023/04/08:2023/04/14[dcom] OR 2023/04/08:2023/04/14[mhda]  OR 2023/04/08:2023/04/14[edat])
```
