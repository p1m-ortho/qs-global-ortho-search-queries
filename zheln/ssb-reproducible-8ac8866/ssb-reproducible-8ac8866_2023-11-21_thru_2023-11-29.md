...
When run on November 30, 2023, this query returned [3,184 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-11-21_thru_2023-11-29_3184.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/11/29[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/11/29[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/11/21:2023/11/29[crdt] OR 2023/11/21:2023/11/29[dcom] OR 2023/11/21:2023/11/29[mhda] OR 2023/11/21:2023/11/29[edat])
```
