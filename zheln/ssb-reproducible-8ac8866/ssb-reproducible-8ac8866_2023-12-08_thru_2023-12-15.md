...
When run on December 16, 2023, this query returned [1,741 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-12-08_thru_2023-12-15_1741.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/12/15[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/12/15[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/12/08:2023/12/15[crdt] OR 2023/12/08:2023/12/15[dcom] OR 2023/12/08:2023/12/15[mhda] OR 2023/12/08:2023/12/15[edat])
```
