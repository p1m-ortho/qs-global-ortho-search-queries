...
When run on February 24, 2024, this query returned [2,133 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-02-17_thru_2024-02-23_2133.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/02/23[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/02/23[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/02/17:2024/02/23[crdt] OR 2024/02/17:2024/02/23[dcom] OR 2024/02/17:2024/02/23[mhda] OR 2024/02/17:2024/02/23[edat])
```
