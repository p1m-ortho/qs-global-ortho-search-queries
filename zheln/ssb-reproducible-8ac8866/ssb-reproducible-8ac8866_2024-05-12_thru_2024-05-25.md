...
When run on June 9, 2024, this query returned [4,350 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-05-12_thru_2024-05-25_4350.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/05/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/05/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/05/12:2024/05/25[crdt] OR 2024/05/12:2024/05/25[dcom] OR 2024/05/12:2024/05/25[mhda] OR 2024/05/12:2024/05/25[edat])
```
