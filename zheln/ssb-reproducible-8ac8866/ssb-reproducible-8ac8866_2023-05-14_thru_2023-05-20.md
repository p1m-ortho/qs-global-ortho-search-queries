...
When run on May 21, 2023, this query returned [2,318 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-05-14_thru_2023-05-20_2318.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/05/20[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/05/20[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/05/14:2023/05/20[crdt] OR 2023/05/14:2023/05/20[dcom] OR 2023/05/14:2023/05/20[mhda]  OR 2023/05/14:2023/05/20[edat])
```
