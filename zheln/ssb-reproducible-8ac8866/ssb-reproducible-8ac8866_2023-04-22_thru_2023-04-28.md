...
When run on April 29, 2023, this query returned [1,961 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-04-22_thru_2023-04-28_1961.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/04/28[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/04/28[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/04/22:2023/04/28[crdt] OR 2023/04/22:2023/04/28[dcom] OR 2023/04/22:2023/04/28[mhda]  OR 2023/04/22:2023/04/28[edat])
```
