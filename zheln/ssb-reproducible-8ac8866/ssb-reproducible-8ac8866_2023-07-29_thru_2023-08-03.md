...
When run on August 4, 2023, this query returned [1,893 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-07-29_thru_2023-08-03_1893.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/08/03[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/08/03[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/07/29:2023/08/03[crdt] OR 2023/07/29:2023/08/03[dcom] OR 2023/07/29:2023/08/03[mhda] OR 2023/07/29:2023/08/03[edat])
```
