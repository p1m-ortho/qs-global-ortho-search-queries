...
When run on December 8, 2023, this query returned [2,554 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-11-30_thru_2023-12-07_2554.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/12/07[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/12/07[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/11/30:2023/12/07[crdt] OR 2023/11/30:2023/12/07[dcom] OR 2023/11/30:2023/12/07[mhda] OR 2023/11/30:2023/12/07[edat])
```
