...
When run on November 1, 2023, this query returned [2,117 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-10-24_thru_2023-10-31_2117.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/10/31[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/10/31[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/10/24:2023/10/31[crdt] OR 2023/10/24:2023/10/31[dcom] OR 2023/10/24:2023/10/31[mhda] OR 2023/10/24:2023/10/31[edat])
```
