...
When run on January 20, 2024, this query returned [2,051 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-01-13_thru_2024-01-19_2051.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/01/19[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/01/19[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/01/13:2024/01/19[crdt] OR 2024/01/13:2024/01/19[dcom] OR 2024/01/13:2024/01/19[mhda] OR 2024/01/13:2024/01/19[edat])
```
