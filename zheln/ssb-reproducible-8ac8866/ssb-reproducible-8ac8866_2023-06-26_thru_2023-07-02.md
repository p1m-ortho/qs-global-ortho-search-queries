...
When run on July 3, 2023, this query returned [2,280 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-06-26_thru_2023-07-02_2280.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/07/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/07/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/06/26:2023/07/02[crdt] OR 2023/06/26:2023/07/02[dcom] OR 2023/06/26:2023/07/02[mhda] OR 2023/06/26:2023/07/02[edat])
```
