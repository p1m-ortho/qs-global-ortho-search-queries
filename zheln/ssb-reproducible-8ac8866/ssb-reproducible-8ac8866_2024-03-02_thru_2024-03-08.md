...
When run on March 9, 2024, this query returned [2,257 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-03-02_thru_2024-03-08_2257.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/03/08[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/03/08[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/03/02:2024/03/08[crdt] OR 2024/03/02:2024/03/08[dcom] OR 2024/03/02:2024/03/08[mhda] OR 2024/03/02:2024/03/08[edat])
```
