...
When run on April 14, 2024, this query returned [2,740 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-04-05_thru_2024-04-13_2740.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/04/13[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/04/13[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/04/05:2024/04/13[crdt] OR 2024/04/05:2024/04/13[dcom] OR 2024/04/05:2024/04/13[mhda] OR 2024/04/05:2024/04/13[edat])
```
