...
When run on January 13, 2024, this query returned [2,391 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-01-06_thru_2024-01-12_2391.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/01/12[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/01/12[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/01/06:2024/01/12[crdt] OR 2024/01/06:2024/01/12[dcom] OR 2024/01/06:2024/01/12[mhda] OR 2024/01/06:2024/01/12[edat])
```
