...
When run on January 27, 2024, this query returned [2,605 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-01-20_thru_2024-01-26_2605.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/01/26[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/01/26[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/01/20:2024/01/26[crdt] OR 2024/01/20:2024/01/26[dcom] OR 2024/01/20:2024/01/26[mhda] OR 2024/01/20:2024/01/26[edat])
```
