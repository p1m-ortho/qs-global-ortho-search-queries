...
When run on April 5, 2024, this query returned [1,605 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-03-30_thru_2024-04-04_1605.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/04/04[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/04/04[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/03/30:2024/04/04[crdt] OR 2024/03/30:2024/04/04[dcom] OR 2024/03/30:2024/04/04[mhda] OR 2024/03/30:2024/04/04[edat])
```
