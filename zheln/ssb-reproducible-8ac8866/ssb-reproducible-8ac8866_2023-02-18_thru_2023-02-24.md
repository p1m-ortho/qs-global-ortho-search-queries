...
When run on February 25, 2023, this query returned [2,190 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-02-18_thru_2023-02-24_2190.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/02/24[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/02/24[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/02/18:2023/02/24[crdt] OR 2023/02/18:2023/02/24[dcom] OR 2023/02/18:2023/02/24[mhda]  OR 2023/02/18:2023/02/24[edat])
```
