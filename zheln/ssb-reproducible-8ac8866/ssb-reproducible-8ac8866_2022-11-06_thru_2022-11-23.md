...
When run on November 24, 2022, this query returned [5,471 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2022-11-06_thru_2022-11-23_5471.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2022/11/23[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2022/11/23[dcom]
                )
                NOT
                (
                    (
...
) AND (2022/11/06:2022/11/23[crdt] OR 2022/11/06:2022/11/23[dcom] OR 2022/11/06:2022/11/23[mhda]  OR 2022/11/06:2022/11/23[edat])
```
