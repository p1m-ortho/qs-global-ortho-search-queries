...
When run on March 30, 2024, this query returned [2,314 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-03-23_thru_2024-03-29_2314.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/03/29[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/03/29[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/03/23:2024/03/29[crdt] OR 2024/03/23:2024/03/29[dcom] OR 2024/03/23:2024/03/29[mhda] OR 2024/03/23:2024/03/29[edat])
```
