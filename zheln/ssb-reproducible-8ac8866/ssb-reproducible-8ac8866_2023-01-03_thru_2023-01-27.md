...
When run on January 28, 2023, this query returned [7,341 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-01-03_thru_2023-01-27_7341.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/01/27[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/01/27[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/01/03:2023/01/27[crdt] OR 2023/01/03:2023/01/27[dcom] OR 2023/01/03:2023/01/27[mhda]  OR 2023/01/03:2023/01/27[edat])
```
