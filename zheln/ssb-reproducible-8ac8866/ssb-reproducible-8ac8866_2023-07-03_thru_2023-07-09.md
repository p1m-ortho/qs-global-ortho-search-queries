...
When run on July 10, 2023, this query returned [1,942 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-07-03_thru_2023-07-09_1942.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/07/09[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/07/09[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/07/03:2023/07/09[crdt] OR 2023/07/03:2023/07/09[dcom] OR 2023/07/03:2023/07/09[mhda] OR 2023/07/03:2023/07/09[edat])
```
