...
When run on December 23, 2023, this query returned [3,156 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-12-16_thru_2023-12-22_3156.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/12/22[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/12/22[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/12/16:2023/12/22[crdt] OR 2023/12/16:2023/12/22[dcom] OR 2023/12/16:2023/12/22[mhda] OR 2023/12/16:2023/12/22[edat])
```
