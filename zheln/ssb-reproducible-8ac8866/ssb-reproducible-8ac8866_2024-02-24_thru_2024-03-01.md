...
When run on March 2, 2024, this query returned [2,363 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-02-24_thru_2024-03-01_2363.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/03/01[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/03/01[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/02/24:2024/03/01[crdt] OR 2024/02/24:2024/03/01[dcom] OR 2024/02/24:2024/03/01[mhda] OR 2024/02/24:2024/03/01[edat])
```
