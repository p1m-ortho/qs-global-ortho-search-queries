...
When run on March 16, 2024, this query returned [2,354 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-03-09_thru_2024-03-15_2354.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/03/15[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/03/15[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/03/09:2024/03/15[crdt] OR 2024/03/09:2024/03/15[dcom] OR 2024/03/09:2024/03/15[mhda] OR 2024/03/09:2024/03/15[edat])
```
