...
When run on April 8, 2023, this query returned [2,199 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-04-01_thru_2023-04-07_2199.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/04/07[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/04/07[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/04/01:2023/04/07[crdt] OR 2023/04/01:2023/04/07[dcom] OR 2023/04/01:2023/04/07[mhda]  OR 2023/04/01:2023/04/07[edat])
```
