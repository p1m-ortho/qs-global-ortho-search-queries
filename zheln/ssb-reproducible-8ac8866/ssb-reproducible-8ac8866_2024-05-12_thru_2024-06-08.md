...
When run on June 9, 2024, this query returned [8,238 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-05-12_thru_2024-06-08_8238.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/06/08[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/06/08[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/05/12:2024/06/08[crdt] OR 2024/05/12:2024/06/08[dcom] OR 2024/05/12:2024/06/08[mhda] OR 2024/05/12:2024/06/08[edat])
```
