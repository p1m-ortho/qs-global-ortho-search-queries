...
When run on May 28, 2023, this query returned [2,208 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-05-21_thru_2023-05-27_2208.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/05/27[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/05/27[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/05/21:2023/05/27[crdt] OR 2023/05/21:2023/05/27[dcom] OR 2023/05/21:2023/05/27[mhda]  OR 2023/05/21:2023/05/27[edat])
```
