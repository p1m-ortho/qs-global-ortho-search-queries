...
When run on May 12, 2024, this query returned [7,876 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-04-14_thru_2024-05-11_7876.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/05/11[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/05/11[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/04/14:2024/05/11[crdt] OR 2024/04/14:2024/05/11[dcom] OR 2024/04/14:2024/05/11[mhda] OR 2024/04/14:2024/05/11[edat])
```
