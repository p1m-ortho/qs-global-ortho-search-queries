...
When run on February 18, 2023, this query returned [2,461 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-02-11_thru_2023-02-17_2461.txt).

So, now we know that this can happen!
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/02/17[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/02/17[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/02/11:2023/02/17[crdt] OR 2023/02/11:2023/02/17[dcom] OR 2023/02/11:2023/02/17[mhda]  OR 2023/02/11:2023/02/17[edat])
```
