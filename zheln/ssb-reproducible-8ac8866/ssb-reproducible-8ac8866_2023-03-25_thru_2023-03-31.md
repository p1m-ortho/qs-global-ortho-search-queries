...
When run on April 1, 2023, this query returned [2,633 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-03-25_thru_2023-03-31_2633.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/03/31[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/03/31[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/03/25:2023/03/31[crdt] OR 2023/03/25:2023/03/31[dcom] OR 2023/03/25:2023/03/31[mhda]  OR 2023/03/25:2023/03/31[edat])
```
