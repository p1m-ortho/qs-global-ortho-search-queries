...
When run on April 22, 2023, this query returned [1,817 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-04-15_thru_2023-04-21_1817.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/04/21[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/04/21[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/04/15:2023/04/21[crdt] OR 2023/04/15:2023/04/21[dcom] OR 2023/04/15:2023/04/21[mhda]  OR 2023/04/15:2023/04/21[edat])
```
