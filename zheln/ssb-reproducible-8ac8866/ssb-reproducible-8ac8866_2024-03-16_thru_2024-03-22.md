...
When run on March 23, 2024, this query returned [2,146 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-03-16_thru_2024-03-22_2146.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/03/22[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/03/22[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/03/16:2024/03/22[crdt] OR 2024/03/16:2024/03/22[dcom] OR 2024/03/16:2024/03/22[mhda] OR 2024/03/16:2024/03/22[edat])
```
