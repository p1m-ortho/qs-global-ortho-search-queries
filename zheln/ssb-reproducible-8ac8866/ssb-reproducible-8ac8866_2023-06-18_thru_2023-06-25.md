...
When run on June 26, 2023, this query returned [2,152 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-06-18_thru_2023-06-25_2152.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/06/25[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/06/25[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/06/18:2023/06/25[crdt] OR 2023/06/18:2023/06/25[dcom] OR 2023/06/18:2023/06/25[mhda] OR 2023/06/18:2023/06/25[edat])
```
