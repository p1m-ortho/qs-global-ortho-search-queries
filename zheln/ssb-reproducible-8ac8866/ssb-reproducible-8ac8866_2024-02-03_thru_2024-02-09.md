...
When run on February 10, 2024, this query returned [2,434 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-02-03_thru_2024-02-09_2434.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/02/09[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/02/09[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/02/03:2024/02/09[crdt] OR 2024/02/03:2024/02/09[dcom] OR 2024/02/03:2024/02/09[mhda] OR 2024/02/03:2024/02/09[edat])
```
