...
When run on February 17, 2024, this query returned [2,432 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-02-10_thru_2024-02-16_2432.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/02/16[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/02/16[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/02/10:2024/02/16[crdt] OR 2024/02/10:2024/02/16[dcom] OR 2024/02/10:2024/02/16[mhda] OR 2024/02/10:2024/02/16[edat])
```
