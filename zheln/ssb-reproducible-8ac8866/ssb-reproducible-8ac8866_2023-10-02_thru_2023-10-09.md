...
When run on October 10, 2023, this query returned [2,197 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-10-02_thru_2023-10-09_2197.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/10/09[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/10/09[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/10/02:2023/10/09[crdt] OR 2023/10/02:2023/10/09[dcom] OR 2023/10/02:2023/10/09[mhda] OR 2023/10/02:2023/10/09[edat])
```
