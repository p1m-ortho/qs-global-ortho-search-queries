...
When run on October 24, 2023, this query returned [2,269 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-10-18_thru_2023-10-23_2269.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/10/23[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/10/23[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/10/18:2023/10/23[crdt] OR 2023/10/18:2023/10/23[dcom] OR 2023/10/18:2023/10/23[mhda] OR 2023/10/18:2023/10/23[edat])
```
