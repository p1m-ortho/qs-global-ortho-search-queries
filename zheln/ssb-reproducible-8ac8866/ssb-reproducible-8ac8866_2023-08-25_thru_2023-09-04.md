...
When run on September 5, 2023, this query returned [3,061 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-08-25_thru_2023-09-04_3061.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/09/04[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/09/04[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/08/25:2023/09/04[crdt] OR 2023/08/25:2023/09/04[dcom] OR 2023/08/25:2023/09/04[mhda] OR 2023/08/25:2023/09/04[edat])
```
