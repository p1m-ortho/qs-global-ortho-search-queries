...
When run on July 29, 2023, this query returned [2,947 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-07-18_thru_2023-07-28_2947.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/07/28[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/07/28[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/07/18:2023/07/28[crdt] OR 2023/07/18:2023/07/28[dcom] OR 2023/07/18:2023/07/28[mhda] OR 2023/07/18:2023/07/28[edat])
```
