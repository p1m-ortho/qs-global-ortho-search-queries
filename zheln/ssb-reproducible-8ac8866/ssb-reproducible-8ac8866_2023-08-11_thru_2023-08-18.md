...
When run on August 19, 2023, this query returned [2,866 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-08-11_thru_2023-08-18_2866.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/08/18[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/08/18[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/08/11:2023/08/18[crdt] OR 2023/08/11:2023/08/18[dcom] OR 2023/08/11:2023/08/18[mhda] OR 2023/08/11:2023/08/18[edat])
```
