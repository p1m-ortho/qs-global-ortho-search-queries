...
When run on November 6, 2023, this query returned [2,117 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-11-01_thru_2023-11-05_2117.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/11/05[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/11/05[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/11/01:2023/11/05[crdt] OR 2023/11/01:2023/11/05[dcom] OR 2023/11/01:2023/11/05[mhda] OR 2023/11/01:2023/11/05[edat])
```
