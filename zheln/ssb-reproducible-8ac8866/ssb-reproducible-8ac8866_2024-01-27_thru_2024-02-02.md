...
When run on February 3, 2024, this query returned [2,378 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2024-01-27_thru_2024-02-02_2378.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2024/02/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2024/02/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2024/01/27:2024/02/02[crdt] OR 2024/01/27:2024/02/02[dcom] OR 2024/01/27:2024/02/02[mhda] OR 2024/01/27:2024/02/02[edat])
```
