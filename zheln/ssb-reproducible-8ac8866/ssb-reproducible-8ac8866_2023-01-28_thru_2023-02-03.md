...
When run on February 4, 2023, this query returned [2,215 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-01-28_thru_2023-02-03_2215.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/02/03[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/02/03[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/01/28:2023/02/03[crdt] OR 2023/01/28:2023/02/03[dcom] OR 2023/01/28:2023/02/03[mhda]  OR 2023/01/28:2023/02/03[edat])
```
