...
When run on March 3, 2023, this query returned [2,944 records](https://github.com/p1m-ortho/qs-global-ortho-search-queries/blob/global-sr-query/zheln/summary-systematic-set/summary-systematic-set_2023-02-25_thru_2023-03-02_2944.txt).
        ...
        (
            (
                (
                    ...
                    AND
                    1865/01/01:2023/03/02[crdt]
                )
                NOT
                (
                    "comment"[pt]
                    AND
                    1865/01/01:2023/03/02[dcom]
                )
                NOT
                (
                    (
...
) AND (2023/02/25:2023/03/02[crdt] OR 2023/02/25:2023/03/02[dcom] OR 2023/02/25:2023/03/02[mhda]  OR 2023/02/25:2023/03/02[edat])
```
