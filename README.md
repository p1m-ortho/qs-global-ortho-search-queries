...
* В этом обзоре используем следующую объединенную форму скрининга и картирования в [FormTools](https://formtools.org) (эту форму разработал впервые для этого обзора; не пилотировал ее):
