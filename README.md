...
При перезапуске 17 июня 2020 (уже в новом Пабмеде) выдал 1 944 записи. Результаты не выгружаю, так как хотел, чтобы они были с аннотациями, а еще не продумал, в каком формате оптимально экспортировать с аннотациями для RESCUER (для скрининга в FormTools).
