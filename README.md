...
* Скрининг и картирования выполним перекрестно с маскированием вдвоем: [Наталья Меньшова](https://github.com/DiesNat) и [Павел Желнов](https://github.com/pussiatoday).
